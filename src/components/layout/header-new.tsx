  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-20 items-center justify-between">
        ...
        {/* Navigation - Centered and evenly spaced */}
              ...
              <Link href="/cart" className="relative">
                <ShoppingCart className="h-6 w-6 stroke-[2.5]" />
                 {isMounted && totalItems > 0 && (
                  <Badge variant="destructive" className="absolute -top-2 -right-2 h-5 w-5 justify-center p-0 font-bold">{totalItems}</Badge>
                 )}
               ...
               <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                     <Button variant="ghost" size="icon" className="h-11 w-11">
                        <UserCircle className="h-6 w-6 stroke-[2.5]" />
